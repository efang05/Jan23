...
//        }
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        if (voltagemode == "teleop"){
            leftFront.setPower(v);
            leftRear.setPower(v1);
            rightRear.setPower(v2);
            rightFront.setPower(v3);
        }else {
            double voltagecompval = 12/batteryVoltageSensor.getVoltage();
            leftFront.setPower(v*voltagecompval);
            leftRear.setPower(v1*voltagecompval);
            rightRear.setPower(v2*voltagecompval);
            rightFront.setPower(v3*voltagecompval);
        }
    }
